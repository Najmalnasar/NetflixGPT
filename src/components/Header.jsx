...
const Header = () => {
  ...
  return (
    <div className="absolute w-screen px-10 py-2 bg-gradient-to-b  from-black z-40 flex  flex-col md:flex-row justify-between ">
      <img className="w-44 mx-auto md:mx-0" src={LOG0} alt="logo" />
      {user && (
